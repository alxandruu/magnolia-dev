 ...
 *
 */
package info.magnolia.training.fullstack.bookstore.contentapp.components;
 ...
 */
public class BookstoresListComponentModel<RD extends ConfiguredTemplateDefinition> extends RenderingModelImpl<RD> {
	    ...
	    @Inject
	    public BookstoresListComponentModel(Node content, RD definition, RenderingModel<?> parent, TemplatingFunctions templatingFunctions) {
